...
/**
 * Ein Referenzprojekt. Projekte leben eigenständig, damit die Liste wachsen kann,
 * ohne dass die Startseite unübersichtlich wird. Welche davon auf der Startseite
 * erscheinen, wird unter „Startseite → Arbeiten“ ausgewählt.
 */
export const project = defineType({
  ...
  preview: {
    ...
    prepare({title, description, year}) {
      return {title, subtitle: [year, description].filter(Boolean).join(' · ')}
    },
  },
})
